...
public class TransferToEntityPerson {
    ...
    @Test
    @Description("Тестовый кейс: 'Перевод на счёт физического лица'")
    ...
    public void clickReceiverAccount() {
        ...
        receiverAccount.sendKeys("KZ036010241000050569");
