...
public class TransferFromCardToDepositNegative {
    ...
    @Test
    @Description("Тестовый кейс: 'Перевод c карты на депозит'(Негативный)")
    public void testTransferFromCardToDeposit() {
        clickTransfer();
        inputOTP("1111");
    ...
    @Description("Выбрать карту, откуда будет совершён перевод")
    public void chooseCard() {
        ...
        Allure.addAttachment("Выбрать карту, откуда будет совершён перевод", "image/png",
                new ByteArrayInputStream(screenshot), "png");
    }
