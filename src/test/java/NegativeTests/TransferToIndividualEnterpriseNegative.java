...
public class TransferToIndividualEnterpriseNegative {
    ...
    @Test
    @Description("Тестовый кейс: 'Перевод на номер счёта ИП'(Негативный)")
    public void testTransferToIndividualEnterprise() {
        clickTransfer();
        inputOTP("1111");
        clickAllTransfers();
        clickPhoneAccount();
