...
public class LoginNegative {
    ...
    @Test
    @Description("Tестовый кейс: 'Вход в приложение'(Негативный)")
    ...
    public void inputPassword() {
        WebElement pwd = androidDriver.findElement(By.xpath(Locators.INPUT_PASSWORD));
        pwd.click();
        PrivateData password = new PrivateData();
        pwd.sendKeys(password.getPassword());
